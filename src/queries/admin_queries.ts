...
export const read_all_seo_record = `select sc.*, si.image_id as image_id, si.title as image_title, si.alt as image_alt, si.url as image_url from seo_config sc left join seo_images si on si.page = sc.page`;
...
export const get_seo_for_page = `select sc.*, si.image_id as image_id, si.title as image_title, si.alt as image_alt, si.url as image_url from seo_config sc left join seo_images si on si.page = sc.page where sc.page = ?`;
...
export const update_image_meta = `update seo_images set title = ?, alt = ? where image_id = ?`;
